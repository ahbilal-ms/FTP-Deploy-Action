...
lftp $WDEFAULT_METHOD://$FTP_SERVER:$WDEFAULT_PORT -u $FTP_USERNAME,$FTP_PASSWORD -e "set xfer:clobber on;set ftp:ssl-allow no; get $WDEFAULT_REMOTE_DIR -o $WDEFAULT_LOCAL_DIR; quit"
